        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 text-lg leading-7 text-zinc-700">
              Waar pensioen vroeger vaak automatisch werd opgebouwd via een werkgever,
              is dat nu steeds minder vanzelfsprekend. Door flexibele contracten,
              zelfstandig ondernemerschap of eigen keuzes ontstaat sneller een gat.
              Het gevolg: later minder inkomen dan verwacht — zonder dat je het nu doorhebt.
            </p>
            ...
            <ul className="mt-7 space-y-4 text-zinc-800">
              <li className="flex gap-3">
                ...
                <span>
                  <strong>Zzp’ers</strong> moeten hun pensioen volledig zelf regelen.
                  In de praktijk wordt dit vaak uitgesteld — met jaren aan gemiste opbouw.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-2 w-2 rounded-full bg-emerald-600" />
                <span>
                  <strong>Loondienst zonder regeling</strong> komt vaker voor dan gedacht
                  (de zogeheten “witte vlek”).
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-2 w-2 rounded-full bg-emerald-600" />
                <span>
                  Ook <strong>DGA’s/BV-ondernemers</strong> lopen regelmatig een
                  privé-pensioengat op door lage of onregelmatige opbouw.
                </span>
              </li>
            </ul>
            ...
            <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-6 space-y-4">
              ...
              <div className="rounded-2xl border border-zinc-200 bg-white p-5">
                ...
                <p className="mt-2 text-sm text-zinc-700">
                  Zonder overzicht weet je niet hoeveel je écht opbouwt,
                  wat een slimme maandelijkse inleg kan doen
                  of welk fiscaal voordeel je laat liggen.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-zinc-200 bg-white p-5">
                ...
                <p className="mt-2 text-sm text-zinc-700">
                  Je krijgt eerst inzicht. Daarna beslis je pas
                  of en hoe je verder wil — zonder druk of verplichtingen.
                </p>
              </div>
                ...
                <ul className="mt-3 space-y-2 text-sm">
                  ...
                  <li>
                    <a
                      ...
                      className="underline underline-offset-4 hover:text-zinc-900"
                    >
                      Knab — Pensioenopbouw bij zzp’ers (2024)
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="underline underline-offset-4 hover:text-zinc-900"
                    >
                      Centraal Beheer — Pensioenvoorbereiding (2025)
                    </a>
                  </li>
                </ul>
              </div>
